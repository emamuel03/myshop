...
function Checkout(props) {
  ...
  function getSteps() {
    return ['Informacion del cliente', 'Detalles de envio', 'Informacion de pago'];
  }
      ...
      case 1:
        return (
          <>
            ...
            <FormControl className={classes.formControl}>
              <InputLabel id="shippingOption-label">Metodo de pago</InputLabel>

              <Select
                labelId="shippingOption-label"
                id="shippingOption"
                label="Opcion de envio"
                fullWidth
